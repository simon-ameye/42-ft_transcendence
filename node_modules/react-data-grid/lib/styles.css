@layer rdg.Cell {.c1wupbe7-0-0-beta-20 {
...
@layer rdg {
    ...
    @layer Root {.r104f42s7-0-0-beta-20 {
...
@layer rdg.Row {.r1otpg647-0-0-beta-20 {
    display: contents;
...
@layer rdg.CheckboxLabel {.c8rwwhf7-0-0-beta-20 {
    cursor: pointer;
    display: flex;
    align-items: center;
...
@layer rdg.GroupCellContent {.gb8l2vs7-0-0-beta-20 {
    outline: none
}
  }
...
@layer rdg.MeasuringCell {.m1l09lto7-0-0-beta-20 {
    contain: strict;
    grid-row: 1;
    visibility: hidden
}
...
@layer rdg.SortableHeaderCell {.h1e8ezgp7-0-0-beta-20 {
    cursor: pointer;
    display: flex
}
...
@layer rdg.HeaderCell {.celq7o97-0-0-beta-20 {
    touch-action: none
}
...
@layer rdg.HeaderRow {.h197vzie7-0-0-beta-20 {
    display: contents;
...
@layer rdg.Cell {.ccpfvsn7-0-0-beta-20 {
...
@layer rdg.SummaryCell {.s1n3hxke7-0-0-beta-20 {
...
@layer rdg.SummaryRow {.snfqesz7-0-0-beta-20 {
...
@layer rdg.EditCell {.c1tngyp17-0-0-beta-20 {
    padding: 0
}
  }


@layer rdg.DragHandle {.cadd3bp7-0-0-beta-20 {
    cursor: move;
    position: absolute;
    inset-inline-end: 0;
    inset-block-end: 0;
...
@layer rdg.SortIcon {.a1mygwml7-0-0-beta-20 {
    fill: currentColor
}
...
@layer rdg.TextEditor {.tlmcuo07-0-0-beta-20 {
    appearance: none;
